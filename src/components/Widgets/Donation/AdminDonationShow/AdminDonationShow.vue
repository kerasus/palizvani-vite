...
export default {
  ...
  data: () => {
    return {
      ...
      indexRouteName: 'Admin.Donation.List',
      inputs: [
  ...
  created() {
    this.api = APIGateway.donation.APIAdresses.byId(this.$route.params.id)
  },
  mounted() {
    this.setActionBtn()
    this.loadCategories()

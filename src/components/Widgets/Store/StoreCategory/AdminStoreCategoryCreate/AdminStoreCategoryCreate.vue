<template>
  <div class="AdminStoreCategoryCreate"
...
export default {
  name: 'AdminStoreCategoryCreate',
  components: { EntityCreate },
  mixins: [mixinWidget],
  props: {
    title: {
      type: String,
      default: 'ایجاد دسته محصول'
    },
    parent: {
      type: Number,
      default: null
  ...
  data () {
    return {
      ...
      entityIdKey: 'id',
      entityParamKey: 'id',
      showRouteName: 'Admin.Store.Category.Show',
      indexRouteName: 'Admin.Store.Category.List',
      inputs: [
        ...
        { type: 'hidden', name: 'parent', responseKey: 'parent', value: this.parent },

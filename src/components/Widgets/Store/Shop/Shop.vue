...
export default {
  ...
  data () {
    return {
      ...
      productInputs: [
        ...
        { type: 'hidden', name: 'store_category__in', value: null },
  ...
  methods: {
    ...
    updateProductFilters () {
      ...
      FormBuilderAssist.setAttributeByName(this.productInputs, 'store_category__in', 'value', this.sidebarFilters.store_category__in?.join())

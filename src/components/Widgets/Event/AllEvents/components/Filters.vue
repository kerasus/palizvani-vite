<template>
  <q-card class="filter-card all-event-widget">
    ...
    <q-card-section class="filter-card-filter-section filter-card-section">
      <div class="row q-col-gutter-md">
        ...
        <div class="col-md-3">
          <div>وضعیت رویداد</div>
          <select-control v-model:value="localFilters.eventStatus"
        ...
        <div class="col-md-3">
          ...
          <select-control v-model:value="localFilters.holding_type"
                          :options="eventHoldingTypeOptions"
                          optionValue="value"
                          optionLabel="label" />
        </div>
        <div class="col-md-3">
...
export default {
  ...
  computed: {
    ...
    eventStatuses () {
      return (new Event()).statusEnums.filter(item => item.showInUserFilters)
    },

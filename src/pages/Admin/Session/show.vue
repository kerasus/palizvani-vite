  ...
  data () {
    return {
      ...
      inputs: [
        ...
        { type: 'dateTime', name: 'beginning_time', responseKey: 'beginning_time', label: 'زمان شروع جلسه', placeholder: ' ', col: 'col-md-6 col-12' },
        { type: 'dateTime', name: 'ending_time', responseKey: 'ending_time', label: 'زمان پایان جلسه', placeholder: ' ', col: 'col-md-6 col-12' },

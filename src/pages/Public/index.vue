...
export default {
  ...
  //             marginTop: '-120px',
  //             minHeight: '100vh',
  //             backgroundImage: "url('assets/images/web/homepage-first-section-background.png')",
  //             backgroundAttachment: 'fixed'
  //           }
  //         }
  //       },
  //       {
  //         data: { rows: [{ cols: [{ widgets: [{ name: 'ClassroomCarousel' }] }], options: { boxed: true } }] },
  //         options: { background: { color: '#F6F6F6' } }
  //       }
  //     ]
  //   }
  // }
